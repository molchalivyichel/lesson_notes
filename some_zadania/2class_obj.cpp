...
class Integer
{
    ...
    public:
        ...
        Integer(int p_variable);
        Integer();
};   
             
int Integer::getVariable()
{
    return variable;
}
void Integer::editVariable(int p_variable)
{
    variable = p_variable;
}
Integer::Integer(int p_variable) : variable(p_variable)
{
    variable = p_variable;
    cout << "Object was create!" << endl;
}
Integer::Integer() : variable(0)
{
    cout << "Object was create!" << endl;
}    
